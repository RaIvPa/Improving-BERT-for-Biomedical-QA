...
test_path = "/scratch/oe7/rp3665/datasets/Task9BGoldenEnriched/Task9BGoldenEnriched/9B4_golden.json"


datasets = load_dataset('csv', data_files={"train": '/scratch/oe7/rp3665/datasets/batch_4/training_data.csv', 
                                           "validation": "/scratch/oe7/rp3665/datasets/batch_4/validation_data.csv",
                                           "test": "/scratch/oe7/rp3665/datasets/batch_4/test_data.csv"
                                           })
