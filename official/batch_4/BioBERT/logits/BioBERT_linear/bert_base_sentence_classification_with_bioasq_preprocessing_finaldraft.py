...
tokenizer = AutoTokenizer.from_pretrained("/scratch/oe7/rp3665/models/biobert")
model = TFAutoModelForSequenceClassification.from_pretrained("/scratch/oe7/rp3665/models/biobert", num_labels=2)
