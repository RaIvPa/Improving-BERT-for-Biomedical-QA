...
test_path = "/scratch/oe7/rp3665/datasets/Task9BGoldenEnriched/Task9BGoldenEnriched/9B5_golden.json"


datasets = load_dataset('csv', data_files={"train": '/scratch/oe7/rp3665/datasets/batch_5/training_data.csv', 
                                           "validation": "/scratch/oe7/rp3665/datasets/batch_5/validation_data.csv",
                                           "test": "/scratch/oe7/rp3665/datasets/batch_5/test_data.csv"
                                           })
