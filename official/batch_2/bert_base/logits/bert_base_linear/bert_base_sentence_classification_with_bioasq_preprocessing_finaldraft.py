...
test_path = "/scratch/oe7/rp3665/datasets/Task9BGoldenEnriched/Task9BGoldenEnriched/9B2_golden.json"


datasets = load_dataset('csv', data_files={"train": '/scratch/oe7/rp3665/datasets/batch_2/training_data.csv', 
                                           "validation": "/scratch/oe7/rp3665/datasets/batch_2/validation_data.csv",
                                           "test": "/scratch/oe7/rp3665/datasets/batch_2/test_data.csv"
                                           })
...
test_hypothesis = get_top_n(test_rank, 2)
