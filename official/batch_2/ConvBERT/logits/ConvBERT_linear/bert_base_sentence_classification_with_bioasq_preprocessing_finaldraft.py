...
tokenizer = AutoTokenizer.from_pretrained("/scratch/oe7/rp3665/models/convbert")
model = TFAutoModelForSequenceClassification.from_pretrained("/scratch/oe7/rp3665/models/convbert", num_labels=2)
