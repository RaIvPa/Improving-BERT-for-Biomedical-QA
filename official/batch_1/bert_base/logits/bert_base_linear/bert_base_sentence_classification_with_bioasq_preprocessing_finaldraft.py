...
datasets = load_dataset('csv', data_files={"train": '/scratch/oe7/rp3665/datasets/batch_1/training_data.csv', 
                                           "validation": "/scratch/oe7/rp3665/datasets/batch_1/validation_data.csv",
                                           "test": "/scratch/oe7/rp3665/datasets/batch_1/test_data.csv"
                                           })
