...
tokenizer = AutoTokenizer.from_pretrained("/scratch/oe7/rp3665/models/bert_base")
model = TFAutoModelForSequenceClassification.from_pretrained("/scratch/oe7/rp3665/models/bert_base", num_labels=2)

model.classifier.activation = tf.keras.activations.linear
...
test_path = "/scratch/oe7/rp3665/datasets/Task9BGoldenEnriched/Task9BGoldenEnriched/9B1_golden.json"
create_training_dataset('/scratch/oe7/rp3665/datasets/training_data.csv', train_path, dataset_split_num)
create_validation_dataset('/scratch/oe7/rp3665/datasets/validation_data.csv', validation_path, dataset_split_num)
create_test_dataset('/scratch/oe7/rp3665/datasets/test_data.csv', test_path)
...
datasets = load_dataset('csv', data_files={"train": '/scratch/oe7/rp3665/datasets/training_data.csv', 
                                           "validation": "/scratch/oe7/rp3665/datasets/validation_data.csv",
                                           "test": "/scratch/oe7/rp3665/datasets/test_data.csv"
                                           })
